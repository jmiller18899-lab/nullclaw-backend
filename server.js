/**
 * NullClaw Mission Control — Glitch Proxy Server
 *
 * Routes:
 *   POST /api/messages        → Anthropic API (/v1/messages)
 *   GET  /health              → Health check
 *
 * The user's Anthropic API key is passed from the browser in the
 * x-api-key header and forwarded directly to Anthropic.
 * This server never stores keys — it only proxies the request.
 */
